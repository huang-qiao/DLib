...
BOOST_dynamic_bitset_is_numeric(char);
  ...
  BOOST_dynamic_bitset_is_numeric(::DBoost::long_long_type);
  BOOST_dynamic_bitset_is_numeric(::DBoost::ulong_long_type);
#endif
...
public:
    ...
    :m_bits(alloc),
     m_num_bits(0)
    {
        using DUtils::detail::dynamic_bitset_impl::value_to_type;
        using DUtils::detail::dynamic_bitset_impl::is_numeric;
...
private:
                                 ...
                                 const Allocator& alloc*/)
    {
        ...
        typedef DUtils::detail::dynamic_bitset_impl
...
template <typename Block, typename Allocator>
inline dynamic_bitset<Block, Allocator>::
//dynamic_bitset(dynamic_bitset<Block, Allocator>&& b) : m_bits(DUtils::move(b.m_bits)), m_num_bits(DUtils::move(b.m_num_bits))
...
{
    //if (DUtils::addressof(b) == this) { return *this; }
    if (std::addressof(b) == this) { return *this; }

    //m_bits = DUtils::move(b.m_bits);
    //m_num_bits = DUtils::move(b.m_num_bits);
...
to_ulong() const
{
  ...
  if (find_next(ulong_width - 1) != npos)
    std::exception(std::overflow_error("DUtils::dynamic_bitset::to_ulong overflow"));
...
dynamic_bitset<Block, Allocator>::m_do_find_from(size_type first_block) const
{
    ...
    return i * bits_per_block + static_cast<size_type>(DUtils::lowest_bit(m_bits[i]));
